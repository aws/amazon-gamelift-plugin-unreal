...
void SAnywhereRegisterComputeMenu::Construct(const FArguments& InArgs)
{
	...
	SBootstrapStatus::OnBootstrapStatusChangedMultiDelegate.AddSP(this, &SAnywhereRegisterComputeMenu::OnBootstrapStatusChanged);
}
...
void SAnywhereRegisterComputeMenu::OnBootstrapStatusChanged(const SBootstrapStatus* /* Sender */)
{
