...
$GAMELIFT_PLUGIN_DIR=Resolve-Path "$PSScriptRoot\..\.."
...
if ($LASTEXITCODE -eq 0) { & "$PSScriptRoot\.import-lightweight-sdk.ps1" $LightWeightUnrealServerSdkVersion $PLUGIN_VERSION }
