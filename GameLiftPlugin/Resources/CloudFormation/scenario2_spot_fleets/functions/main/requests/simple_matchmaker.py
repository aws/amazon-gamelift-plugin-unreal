...
def handler(event, context):
    ...
    if batch_size < num_players_per_game:
        # When exception is thrown, SQS treats the current message as unhandled and lets it come later within the batch.
        raise RuntimeError(f"Not enough players in the batch. Batch Size: {batch_size}. Expected: {num_players_per_game}")
    else:
